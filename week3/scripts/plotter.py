...
plt.figure()
plt.ylim(0, 10)
plt.plot(df_m["t"], (df_m["EK"] + df_m["EP"])/(df_m["EK"][1] + df_m["EP"][1]), label="Midpoint", color=colors['midpoint'])
plt.plot(df_v["t"], (df_v["EK"] + df_v["EP"])/(df_v["EK"][1] + df_v["EP"][1]), label="Verlet", color=colors['verlet'])
plt.plot(df_2["t"], (df_2["EK"] + df_2["EP"])/(df_2["EK"][1] + df_2["EP"][1]), label="RK2", color=colors['rk2'])
plt.plot(df_4["t"], (df_4["EK"] + df_4["EP"])/(df_4["EK"][1] + df_4["EP"][1]), label="RK4", color=colors['rk4'])
plt.xlabel("Time")
